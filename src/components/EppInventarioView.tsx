...
export const EppInventarioView: React.FC<EppInventarioViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#DCD6C8] p-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      <div className="flex items-center justify-between border-b border-[#8FA7D6]/30">
        ...
        <div className="pb-2 flex items-center gap-2">
          <div className="relative">
            <Search className="w-3.5 h-3.5 absolute left-2.5 top-2.5 text-[#5B6A62]" />
            <input
              type="text"
              placeholder="Buscar EPP o colaborador..."
              value={busqueda}
              onChange={e => setBusqueda(e.target.value)}
              className="pl-8 pr-3 py-1.5 bg-white border border-[#DCD6C8] rounded-lg text-xs text-[#1E2A24] focus:outline-none focus:ring-1 focus:ring-[#2F5D50] w-48 sm:w-64"
            />
          </div>
        </div>
      </div>
