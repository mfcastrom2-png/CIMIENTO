...
import { loginConEmail, loginConGoogle, obtenerPerfilUsuario, solicitarRestablecimientoClave } from '../lib/firebase';
...
export const LoginView: React.FC<LoginViewProps> = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.code === 'auth/invalid-credential' ? 'Credenciales inválidas.' : (err?.message || 'No fue posible iniciar sesión.'));
    } finally {
      setIsLoading(false);
    }
  };
