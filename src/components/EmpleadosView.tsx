...
import { Cargo, Empleado, EvaluacionDesempeno, Solicitud, ItemInventarioEPP, SolicitudEntregaEPP, Role } from '../types';
import {
  Users,
  Plus,
  ArrowLeft,
...
interface EmpleadosViewProps {
  ...
  onAddEmpleado: (nuevo: Empleado) => void;
  ...
  if (currentEmpleado) {
    ...
    return (
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#DCD6C8]">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setSelectedEmpleadoId(null)}
              className="p-2 rounded border border-[#DCD6C8] bg-white hover:bg-[#F6F4EF] text-[#5B6A62] transition-colors"
            >
        ...
        {/* Tab Content */}
        {activeTab === 'hv' && (
          <div className="bg-white rounded border border-[#DCD6C8] p-5 space-y-4 shadow-xs">
            <h3 className="font-serif-title text-base font-medium text-[#1E2A24]">
              Datos Generales y Perfil
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Correo corporativo</span>
                <span className="text-[#1E2A24] font-medium break-all">{currentEmpleado.email || '—'}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Teléfono de contacto</span>
                <span className="text-[#1E2A24] font-medium">{currentEmpleado.telefono || '—'}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Cargo formal</span>
                <span className="text-[#1E2A24] font-medium">{getCargoNombre(currentEmpleado.cargoId)}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Núcleo familiar</span>
                <span className="text-[#1E2A24] font-medium">{(currentEmpleado.familia || []).length} personas</span>
              </div>
            </div>

            <div className="pt-3 border-t border-[#DCD6C8] space-y-3 text-xs">
              <div>
                <strong className="block text-[#1E2A24] mb-1">Formación Académica:</strong>
                <p className="text-[#5B6A62] bg-[#F6F4EF] p-3 rounded border border-[#DCD6C8]">
                  {currentEmpleado.formacion || 'Sin registro detallado de formación.'}
                </p>
              </div>
              <div>
                <strong className="block text-[#1E2A24] mb-1">Experiencia y Trayectoria:</strong>
                <p className="text-[#5B6A62] bg-[#F6F4EF] p-3 rounded border border-[#DCD6C8]">
        ...
        {activeTab === 'contrato' && (
          <div className="bg-white rounded border border-[#DCD6C8] p-5 shadow-xs space-y-4">
            <h3 className="font-serif-title text-base font-medium text-[#1E2A24]">
              Condiciones Contractuales
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Tipo de Contrato</span>
                <span className="text-[#1E2A24] font-medium">{currentEmpleado.contrato.tipo}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Salario Asignado</span>
                <span className="text-[#2F5D50] font-bold text-sm">{currentEmpleado.contrato.salario}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Fecha de Inicio</span>
                <span className="text-[#1E2A24] font-medium">{currentEmpleado.contrato.inicio}</span>
              </div>
              <div className="p-3 bg-[#F6F4EF] rounded border border-[#DCD6C8]">
                <span className="text-[#5B6A62] block mb-0.5 font-semibold">Vencimiento / Término</span>
                <span className="text-[#1E2A24] font-medium">{currentEmpleado.contrato.fin || 'Indefinido'}</span>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'historial' && (
          <div className="bg-white rounded border border-[#DCD6C8] p-5 shadow-xs space-y-4">
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-[#E4EDE9] p-3 rounded text-center border border-[#2F5D50]/20">
                <span className="text-xl font-serif-title font-bold text-[#2F5D50]">{aprobadas.length}</span>
                <span className="text-xs text-[#2F5D50] block font-semibold">Aprobadas</span>
              </div>
              <div className="bg-[#F3E3DE] p-3 rounded text-center border border-[#A8503E]/20">
                <span className="text-xl font-serif-title font-bold text-[#A8503E]">{rechazadas.length}</span>
              ...
              <div className="bg-[#F5EAD4] p-3 rounded text-center border border-[#B5842A]/20">
                <span className="text-xl font-serif-title font-bold text-[#B5842A]">{pendientes.length}</span>
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-[#DCD6C8]/60">
                  {empSolicitudes.map(s => (
                    <tr key={s.id} className="hover:bg-[#F6F4EF]/50">
                      <td className="py-2.5 px-3 font-medium text-[#1E2A24]">{s.tipo}</td>
                      <td className="py-2.5 px-3 text-[#5B6A62]">{s.inicio} al {s.fin}</td>
                      <td className="py-2.5 px-3 text-[#5B6A62]">{s.motivo}</td>
                      <td className="py-2.5 px-3">
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                          s.estado === 'Aprobada' ? 'bg-[#E4EDE9] text-[#2F5D50]' :
                          s.estado === 'Rechazada' ? 'bg-[#F3E3DE] text-[#A8503E]' : 'bg-[#F5EAD4] text-[#B5842A]'
                        }`}>
                          {s.estado}
                        </span>
                      </td>
                      <td className="py-2.5 px-3 text-[#5B6A62]">
          ...
          <div className="bg-white rounded border border-[#DCD6C8] p-5 shadow-xs space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-[#DCD6C8]/60">
                  {empEvals.map(ev => (
                    <tr key={ev.id} className="hover:bg-[#F6F4EF]/50">
                      <td className="py-2.5 px-3 font-bold text-[#1E2A24]">{ev.periodo}</td>
                      <td className="py-2.5 px-3 text-[#5B6A62] font-mono">{ev.subtotalResultados} / 50</td>
                      <td className="py-2.5 px-3 text-[#5B6A62] font-mono">{ev.subtotalCompetencias} / 25</td>
                      <td className="py-2.5 px-3 text-[#5B6A62] font-mono">{ev.subtotalCumplimiento} / 15</td>
                      <td className="py-2.5 px-3 text-[#5B6A62] font-mono">{ev.subtotalDesarrollo} / 10</td>
                      <td className="py-2.5 px-3">
                      ...
                      <td className="py-2.5 px-3">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#E4EDE9] text-[#2F5D50]">
                          {ev.clasificacion}
                        </span>
                      </td>
                      <td className="py-2.5 px-3">
                        <span className="text-[11px] font-mono text-[#5B6A62]">
                          {ev.estado}
                        </span>
                      </td>
                      <td className="py-2.5 px-3 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 rounded bg-[#2F5D50] hover:bg-[#223F37] text-white text-xs font-semibold flex items-center gap-1 ml-auto"
                        >
                  ...
                  {empEvals.length === 0 && (
                    <tr>
                      <td colSpan={9} className="py-6 text-center text-[#5B6A62]">
        ...
        {activeTab === 'epps' && (
          <div className="bg-white rounded border border-[#DCD6C8] p-5 shadow-xs space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#DCD6C8]">
              <div>
                <h3 className="font-serif-title text-base font-medium text-[#1E2A24] flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 bg-[#2F5D50] hover:bg-[#223F37] text-white text-xs font-semibold rounded flex items-center gap-1.5 transition-colors shadow-xs"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="bg-[#FAF8F5] p-3.5 rounded-lg border border-[#DCD6C8]">
                <div className="flex items-center gap-2 text-xs text-[#5B6A62] mb-1">
                  <ShieldCheck className="w-4 h-4 text-[#2F5D50]" />
                  <span>Entregas Conformes</span>
                </div>
                <div className="text-2xl font-bold font-serif-title text-[#2F5D50]">
                  {eppsEntregadosCount}
                </div>
                <span className="text-[11px] text-[#5B6A62]">Con acta oficial y firma de entrega</span>
              </div>
              ...
              <div className="bg-[#FAF8F5] p-3.5 rounded-lg border border-[#DCD6C8]">
                ...
                <div className="text-2xl font-bold font-serif-title text-[#D97706]">
                  {eppsPendientesCount}
                </div>
                <span className="text-[11px] text-[#5B6A62]">Pendientes por almacén / SST</span>
              </div>
              ...
              <div className="bg-[#FAF8F5] p-3.5 rounded-lg border border-[#DCD6C8]">
                ...
                <div className="text-sm font-semibold text-[#1E2A24] font-mono mt-1">
                  {ultimaFechaEntrega}
                </div>
                <span className="text-[11px] text-[#5B6A62]">Registro más reciente en hoja de vida</span>
              </div>
            </div>

            {/* Table of Employee EPPs */}
            <div className="overflow-x-auto border border-[#DCD6C8] rounded">
              <table className="w-full text-xs text-left">
                <thead className="bg-[#FAF8F5] border-b border-[#DCD6C8] text-[#5B6A62]">
                  <tr>
                ...
                <tbody className="divide-y divide-[#DCD6C8]/60">
                  {empEpps.map(epp => (
                    <tr key={epp.id} className="hover:bg-[#F6F4EF]/50">
                      <td className="py-2.5 px-3">
                        <div className="font-semibold text-[#1E2A24]">{epp.eppNombre}</div>
                        <div className="text-[10px] font-mono text-[#5B6A62]">{epp.eppCodigo}</div>
                      </td>
                      <td className="py-2.5 px-3 text-[#5B6A62]">{epp.eppCategoria}</td>
                      <td className="py-2.5 px-3">
                        <span className="font-medium text-[#1E2A24]">{epp.cantidad} u.</span>
                        {epp.talla && <span className="text-[#5B6A62] ml-1">({epp.talla})</span>}
                      </td>
                      <td className="py-2.5 px-3 text-[#5B6A62]">{epp.motivo}</td>
                      <td className="py-2.5 px-3 font-mono text-[11px] text-[#5B6A62]">
                        <div>Sol: {epp.fechaSolicitud}</div>
                        {epp.fechaEntrega && (
                          <div className="text-[#2F5D50] font-semibold">Ent: {epp.fechaEntrega}</div>
                        )}
                      </td>
                      <td className="py-2.5 px-3">
                        {epp.estado === 'Entregada' && (
                          <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-[#E4EDE9] text-[#2F5D50]">
                            Entregada
                          </span>
                        )}
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          {epp.estado === 'Entregada' ? (
                            <button
                              ...
                              className="px-2 py-1 rounded bg-[#F6F4EF] hover:bg-[#E4EDE9] text-[#2F5D50] border border-[#DCD6C8] text-[11px] font-semibold flex items-center gap-1 transition-colors"
                            ...
                            <button
                              ...
                              className="px-2 py-1 rounded bg-[#2F5D50] hover:bg-[#223F37] text-white text-[11px] font-semibold flex items-center gap-1 transition-colors"
                            >
                  ...
                  {empEpps.length === 0 && (
                    <tr>
                      <td colSpan={7} className="py-8 text-center text-[#5B6A62]">
                        <HardHat className="w-8 h-8 mx-auto mb-2 text-[#5B6A62]/40" />
                        <p className="font-medium text-[#1E2A24]">No registra asignaciones de dotación o EPP</p>
                        <p className="text-xs text-[#5B6A62] mt-0.5">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded border border-[#DCD6C8] overflow-hidden shadow-xs">
        <div className="p-4 border-b border-[#DCD6C8] flex items-center justify-between">
          <span className="text-xs font-bold text-[#5B6A62] uppercase tracking-wider">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-[#DCD6C8] text-[#5B6A62] bg-[#F6F4EF]/50">
            ...
            <tbody className="divide-y divide-[#DCD6C8]/60">
              {empleados.map(emp => (
                <tr key={emp.id} className="hover:bg-[#F6F4EF]/50">
                  <td className="py-3 px-4 font-medium text-[#1E2A24]">
                    <button
                      onClick={() => setSelectedEmpleadoId(emp.id)}
                      className="text-left hover:text-[#2F5D50] hover:underline"
                    >
                      <div className="font-semibold text-sm text-[#1E2A24]">{emp.nombre}</div>
                      <div className="text-[11px] text-[#5B6A62]">{emp.email || emp.documento}</div>
                    </button>
                  </td>
                  <td className="py-3 px-4 text-[#1E2A24] font-medium">
                    {getCargoNombre(emp.cargoId)}
                  </td>
                  <td className="py-3 px-4 text-[#5B6A62]">
                    {emp.contrato.tipo}
                  </td>
                  <td className="py-3 px-4 text-[#2F5D50] font-semibold">
                    {emp.contrato.salario}
                  </td>
                  <td className="py-3 px-4">
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#E4EDE9] text-[#2F5D50]">
                      Activo
                    </span>
                  </td>
              ...
              {empleados.length === 0 && (
                <tr>
                  <td colSpan={6} className="py-12 px-4 text-center">
                    <div className="w-12 h-12 mx-auto rounded-full bg-[#E4EDE9] text-[#2F5D50] flex items-center justify-center mb-3">
                      <Users className="w-6 h-6" />
                    </div>
                    <h3 className="font-serif-title text-base font-semibold text-[#1E2A24]">
                      Base de datos en la nube lista para producción
                    </h3>
                    <p className="text-xs text-[#5B6A62] mt-1 max-w-md mx-auto">
                    ...
                    <button
                      type="button"
                      onClick={() => setModalOpen(true)}
                      className="mt-4 px-4 py-2 bg-[#2F5D50] hover:bg-[#223F37] text-white text-xs font-semibold rounded inline-flex items-center gap-2 transition-colors shadow-xs"
                    >
                      <Plus className="w-3.5 h-3.5" />
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded border border-[#DCD6C8] max-w-xl w-full p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreate} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Nombre Completo *</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Documento de Identidad *</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Correo Electrónico</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Teléfono</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Cargo a Asignar *</label>
                  <select
                    value={cargoId}
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Tipo de Contrato</label>
                  <select
                    value={contratoTipo}
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Fecha de Ingreso</label>
                  <input
                    type="date"
                    value={inicio}
                ...
                <div>
                  <label className="block font-semibold text-[#5B6A62] mb-1">Salario Mensual</label>
                  <input
                    type="text"
                    placeholder="$0"
                    value={salario}
              ...
              <div>
                <label className="block font-semibold text-[#5B6A62] mb-1">Formación Académica</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-semibold text-[#5B6A62] mb-1">Experiencia Laboral Previa</label>
                <textarea
                  rows={3}
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-[#DCD6C8]">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-white bg-[#2F5D50] hover:bg-[#223F37] rounded font-semibold transition-colors"
                >
                  Registrar Empleado
                </button>
              </div>
